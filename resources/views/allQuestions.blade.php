...
@section('content')
    ...
    <section class="row searchposts">
        <div class="col-md-6 col-md-offset-3 SearchParent">
            <header><h3>Search from All Questions</h3></header>
            <div class="searchArea">
            <form action="allQuestions" method="get"><input type="text" name="searchBar" id="searchBar"><input type="submit" value="Search">Search Returned : {{$searched_posts}} Questions </form>
            <form action="allQuestions" method="get"> 
            <select name="topAllQuestions">
    ...
    <section class="row posts">
        <div class="col-md-6 col-md-offset-3">
            <header><h3>All Questions : {{$num_posts}}</h3></header>
